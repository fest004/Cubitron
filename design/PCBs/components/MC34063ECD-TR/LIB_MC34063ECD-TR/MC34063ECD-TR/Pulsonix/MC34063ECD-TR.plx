...
//372805/1230308/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MC34063ECD-TR" (originalName "MC34063ECD-TR")
	...
	(compDef "MC34063ECD-TR" (originalName "MC34063ECD-TR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "SWC") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "SWE") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "TC") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "GND") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "DRC") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "IPK") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VCC") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "CII") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MC34063ECD-TR"))
		...
		(attr "Mouser Part Number" "511-MC34063ECD-TR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/MC34063ECD-TR?qs=yc0hdvjf4X927o4awNc7hw%3D%3D")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "MC34063ECD-TR")
		(attr "Description" "STMicroelectronics, MC34063ECD-TR")
		(attr "<Hyperlink>" "https://www.st.com/resource/en/datasheet/mc34063ec.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "MC34063ECD-TR.stp")
