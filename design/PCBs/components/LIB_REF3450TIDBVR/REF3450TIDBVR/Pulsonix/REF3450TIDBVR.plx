...
//14919353/1230308/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "REF3450TIDBVR" (originalName "REF3450TIDBVR")
	...
	(compDef "REF3450TIDBVR" (originalName "REF3450TIDBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "REF3450TIDBVR"))
		...
		(attr "Mouser Part Number" "595-REF3450TIDBVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/REF3450TIDBVR?qs=QNEnbhJQKvaJ9wk9nNLvXA%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "REF3450TIDBVR")
		(attr "Description" "Voltage References 5-V, low-drift, low-power, small-footprint series voltage reference")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/ref3450.pdf?ts=1625451766832&ref_url=https%253A%252F%252Fwww.ti.com%252Fsitesearch%252Fdocs%252Funiversalsearch.tsp%253FlangPref%253Den-US%2526searchTerm%253DREF3450TIDBVR%2526nr%253D7")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "REF3450TIDBVR.stp")
