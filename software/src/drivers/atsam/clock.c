...
void peripheral_clks_init(void)
{
    ...
    GCLK_REGS->GCLK_GENCTRL[1] = GCLK_GENCTRL_SRC(6U) | GCLK_GENCTRL_GENEN_Msk | GCLK_GENCTRL_DIV(48);
    ...
    GCLK_REGS->GCLK_PCHCTRL[4] = GCLK_PCHCTRL_GEN(1U) | GCLK_PCHCTRL_CHEN_Msk;
    ...
    GCLK_REGS->GCLK_PCHCTRL[5] = GCLK_PCHCTRL_GEN(1U) | GCLK_PCHCTRL_CHEN_Msk;
    ...
    /* select gclk2, div by 480 ->  48MHz / 480 = 100 MHz */
    ...
    GCLK_REGS->GCLK_PCHCTRL[0] = GCLK_PCHCTRL_GEN(1U) | GCLK_PCHCTRL_CHEN_Msk;
    while ((GCLK_REGS->GCLK_PCHCTRL[0] & GCLK_PCHCTRL_CHEN_Msk) != GCLK_PCHCTRL_CHEN_Msk) //should be != 0 ? 
    {
	/* wait */
    }

    /* connect clock to sercom1 (IMU2) */
    GCLK_REGS->GCLK_PCHCTRL[1] = GCLK_PCHCTRL_GEN(1U) | GCLK_PCHCTRL_CHEN_Msk;
    while ((GCLK_REGS->GCLK_PCHCTRL[1] & GCLK_PCHCTRL_CHEN_Msk) != GCLK_PCHCTRL_CHEN_Msk) //should be != 0 ? 
    {
	/* wait */
    }

    /* connect clock to sercom2 (OLED screen) */
    GCLK_REGS->GCLK_PCHCTRL[2] = GCLK_PCHCTRL_GEN(1U) | GCLK_PCHCTRL_CHEN_Msk;
    while ((GCLK_REGS->GCLK_PCHCTRL[2] & GCLK_PCHCTRL_CHEN_Msk) != GCLK_PCHCTRL_CHEN_Msk) //should be != 0 ? 
    {
	/* wait */
    }
    ...
    */
    ...
    GCLK_REGS->GCLK_PCHCTRL[3] = GCLK_PCHCTRL_GEN(1U) | GCLK_PCHCTRL_CHEN_Msk;
    while ((GCLK_REGS->GCLK_PCHCTRL[3] & GCLK_PCHCTRL_CHEN_Msk) != GCLK_PCHCTRL_CHEN_Msk) //should be != 0 ? 
    {
	/* wait */
    }
