...
#define   ADC_INPUTCTRL_MUXPOS_SCALEDCOREVCC_Val _UINT16_(0x18)                                       /* (ADC_INPUTCTRL) 1/4 Scaled Core Supply  */
#define   ADC_INPUTCTRL_MUXPOS_SCALEDVBAT_Val _UINT16_(0x19)                                       /* (ADC_INPUTCTRL) 1/4 Scaled VBAT Supply  */
#define   ADC_INPUTCTRL_MUXPOS_SCALEDIOVCC_Val _UINT16_(0x1A)                                       /* (ADC_INPUTCTRL) 1/4 Scaled I/O Supply  */
#define   ADC_INPUTCTRL_MUXPOS_BANDGAP_Val    _UINT16_(0x1B)                                       /* (ADC_INPUTCTRL) Bandgap Voltage  */
#define   ADC_INPUTCTRL_MUXPOS_PTAT_Val       _UINT16_(0x1C)                                       /* (ADC_INPUTCTRL) Temperature Sensor TSENSP  */
#define   ADC_INPUTCTRL_MUXPOS_CTAT_Val       _UINT16_(0x1D)                                       /* (ADC_INPUTCTRL) Temperature Sensor TSENSC  */
#define   ADC_INPUTCTRL_MUXPOS_DAC_Val        _UINT16_(0x1E)                                       /* (ADC_INPUTCTRL) DAC Output  */
#define   ADC_INPUTCTRL_MUXPOS_PTC_Val        _UINT16_(0x1F)                                       /* (ADC_INPUTCTRL) PTC output (only on ADC0)  */
...
#define   ADC_REFCTRL_REFSEL_INTVCC0_Val      _UINT8_(0x2)                                         /* (ADC_REFCTRL) 1/2 VDDANA  */
#define   ADC_REFCTRL_REFSEL_INTVCC1_Val      _UINT8_(0x3)                                         /* (ADC_REFCTRL) VDDANA  */
